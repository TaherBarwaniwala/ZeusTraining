...
class Circle {
  ...
  move(x, y) {
    ...
    if (
      this.initialx + offsetx + this.radius + this.lineWidth / 2 >
      this.bounadaryRight
    )
      offsetx =
        this.bounadaryRight -
        (this.initialx + this.radius + this.lineWidth / 2);
    if (
      this.initialx + offsetx - this.radius - this.lineWidth / 2 <
      this.bounadaryLeft
    )
      offsetx =
        this.bounadaryLeft - (this.initialx - this.radius - this.lineWidth / 2);
    if (
      this.initialy + offsety + this.radius + this.lineWidth / 2 >
      this.boundaryDown
    )
      offsety =
        this.boundaryDown - (this.initialy + this.radius + this.lineWidth / 2);
    if (
      this.initialy + offsety - this.radius - this.lineWidth / 2 <
      this.bounadaryUp
    )
      offsety =
        this.bounadaryUp - (this.initialy - this.radius - this.lineWidth / 2);
